...
const Top = () => {
  ...
  return (
    <div style={{width: '100%',top:'0',background:'#fff', position: 'fixed',marginBottom:'5px',padding:' 12px 8px',boxShadow: '0 1px 2px -2px rgb(0 0 0 / 16%), 0 3px 6px 0 rgb(0 0 0 / 12%),1px 2px 5px 2px rgb(0 0 0 / 9%)'}}>
      <div style={{maxWidth: '960px',display:'flex',justifyContent:'space-between',margin: 'auto'}}>
        {/* <span>logo</span> */}
        <div>
