...
// 文章
var Comment = (_dec = (0, _typeorm.Entity)('comments'), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)("increment"), _dec3 = (0, _typeorm.Column)("int"), _dec4 = (0, _typeorm.Column)("number"), _dec5 = (0, _typeorm.Column)("text"), _dec6 = (0, _typeorm.Column)("timestamp"), _dec7 = (0, _typeorm.ManyToOne)(function (type) {
  return _User.User;
}, function (user) {
  return user.comment;
