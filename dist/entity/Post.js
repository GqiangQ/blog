...
// 评论
var Post = (_dec = (0, _typeorm.Entity)('posts'), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)("increment"), _dec3 = (0, _typeorm.Column)("varchar"), _dec4 = (0, _typeorm.Column)("text"), _dec5 = (0, _typeorm.Column)("int"), _dec6 = (0, _typeorm.Column)({
  type: "timestamp"
  ...
  (0, _initializerDefineProperty2["default"])(this, "createAt", _descriptor5, this);
  ...
  (0, _initializerDefineProperty2["default"])(this, "comment", _descriptor8, this);
  ...
  writable: true,
  initializer: null
}), _descriptor5 = (0, _applyDecoratedDescriptor2["default"])(_class2.prototype, "createAt", [_dec6], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
  ...
  writable: true,
  initializer: null
}), _descriptor8 = (0, _applyDecoratedDescriptor2["default"])(_class2.prototype, "comment", [_dec9], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
